...
export default class Header {
    ...
    constructor() {   
        ...
        this.$mainContainer.setAttribute("style", "width: 100vw; height: 600px; background-image: url('https://nt11.mediawz.com/wp-content/uploads/2017/10/img_5452.jpg'); background-size: cover; background-position: center center; display: flex; flex-direction: column; align-items: center;");
        ...
        this.$socialMediaEl.innerHTML = '<button><i class="fab fa-facebook-f"></i></button>';
        this.$socialMediaEl.setAttribute("class", "text-blue-400 bg-gray-200 px-2.5 mr-2 rounded cursor-pointer");

        this.$searchBtn = document.createElement("button");
        this.$searchBtn.innerHTML = '<button><i class="fas fa-search"></i></button>';
        this.$searchBtn.setAttribute("class", "text-blue-400 bg-gray-200 px-2 rounded cursor-pointer");
        ...
        this.$projectsEl.setAttribute("class", "text-white font-bold cursor-pointer");

        this.$priceListEl = document.createElement("p");
        this.$priceListEl.textContent = "Bảng giá";
        this.$priceListEl.setAttribute("class", "text-white font-bold cursor-pointer");

        this.$productsEl = document.createElement("p");
        this.$productsEl.textContent = "Sản phẩm";
        this.$productsEl.setAttribute("class", "text-white font-bold cursor-pointer");
        ...
        this.$promotionEl.setAttribute("class", "text-white font-bold cursor-pointer");
        ...
        this.$organizationEl.setAttribute("class", "text-white font-bold cursor-pointer");

        this.$contactEl = document.createElement("p");
        this.$contactEl.textContent = "Liên hệ";
        this.$contactEl.setAttribute("class", "text-white font-bold cursor-pointer");
    }
